...
<div className="absolute top-0 sm:hidden -left-20"><Image src="/house.jpg" alt='' width={500} height={500} className='h-[90vh] w-fit opacity-20'></Image></div>
<Image src="/cover.png" alt='' width={500} height={500} className='h-[100vh] w-auto pb-7'></Image>
